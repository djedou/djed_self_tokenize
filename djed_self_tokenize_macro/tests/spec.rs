...
fn test_boxed_slice_1() {
    ...
    assert_eq!(t.to_string(), "MyBoxedSlice ( box [ 1u8 , ] )");
}

#[test]
fn test_boxed_slice_2() {
    let value = MyBoxedSlice(Box::new([1u8]));
    let mut t = quote::Tokens::new();
    value.to_custom_tokens(&mut t);
...
fn test_boxed_vec_1() {
    ...
    assert_eq!(t.to_string(), "MyBoxedVec ( box vec! [ 1u8 , ] )");
}
...
fn test_smallvec_1() {
    ...
    assert_eq!(
        t.to_string(),
        "MySmallVec ( SmallVec :: from_buf ( [ 1u8 , 2u8 , 3u8 , 4u8 , ] ) )"
    );
}
...
fn test_smallvec_2() {
    ...
    assert_eq!(
        t.to_string(),
        "MySmallVec ( SmallVec :: from_vec ( vec! [ 1u8 , ] ) )"
    );
}
...
fn test_smallvec_3() {
    ...
    assert_eq!(
        t.to_string(),
        "MySmallVec ( SmallVec :: from_vec ( vec! [ 1u8 , 2u8 , 3u8 , 4u8 , 5u8 , ] ) )"
    );
}
...
fn test_arc_5() {
    ...
    assert_eq!(
        t.to_string(),
        "::std::sync::Arc :: new ( vec! [ 0u8 , 0u8 , 0u8 , 0u8 , 0u8 , 0u8 , 0u8 , 0u8 , 0u8 , 0u8 , ] )"
    );
}
...
fn test_rc_smallvec() {
    ...
    assert_eq!(
        t.to_string(),
        "MyRcSmallVec ( ::std::rc::Rc :: new ( SmallVec :: from_buf ( [ 1u8 , 2u8 , 3u8 , 4u8 , ] ) ) )"
    );
}
...
fn test_arc_smallvec() {
    ...
    assert_eq!(
        t.to_string(),
        "MyArcSmallVec ( ::std::sync::Arc :: new ( SmallVec :: from_buf ( [ 1u8 , 2u8 , 3u8 , 4u8 , ] ) ) )"
    );
}
